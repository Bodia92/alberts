...
/* harmony import */ var _components_initMap__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/initMap */ "./src/js/components/initMap.js");
/* harmony import */ var _components_workspaceCard__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/workspaceCard */ "./src/js/components/workspaceCard.js");
...
/* harmony import */ var _components_sliderInit__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/sliderInit */ "./src/js/components/sliderInit.js");
/* harmony import */ var _components_popupInit__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/popupInit */ "./src/js/components/popupInit.js");
...
/* harmony import */ var _components_ajaxLoad__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./components/ajaxLoad */ "./src/js/components/ajaxLoad.js");
/* harmony import */ var _components_inputNumber__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./components/inputNumber */ "./src/js/components/inputNumber.js");
/* harmony import */ var _components_initAnim__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./components/initAnim */ "./src/js/components/initAnim.js");
/* harmony import */ var _components_interactiveMap__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./components/interactiveMap */ "./src/js/components/interactiveMap.js");
...
__webpack_provided_window_dot_$ = (jquery__WEBPACK_IMPORTED_MODULE_0___default()); // -------------------  dev widget
...
var readyFunc = function readyFunc() {
  console.log('ready');
  (0,_components_workspaceCard__WEBPACK_IMPORTED_MODULE_5__["default"])();
};

var loadFunc = function loadFunc() {
  console.log('page load');
  document.querySelector('body').classList.add('loaded_mod');
  (0,_components_initMap__WEBPACK_IMPORTED_MODULE_4__["default"])();
  (0,_components_sliderInit__WEBPACK_IMPORTED_MODULE_7__["default"])();
  (0,_components_popupInit__WEBPACK_IMPORTED_MODULE_8__["default"])('.popupBtn', '.popupClose', '.popupMember');
  (0,_components_popupInit__WEBPACK_IMPORTED_MODULE_8__["default"])('.popupAnnouncementOpen', '.popupAnnouncementClose', '.popupAnnouncement');
  (0,_components_popupInit__WEBPACK_IMPORTED_MODULE_8__["default"])('.popupEmailOpen', '.popupEmailClose', '.popupEmail');
  (0,_components_popupInit__WEBPACK_IMPORTED_MODULE_8__["default"])('.popupBrochureOpen', '.popupBrochureClose', '.popupBrochure');
  (0,_components_accordion__WEBPACK_IMPORTED_MODULE_9__["default"])('.accordion_title', '.accordion_content');
  (0,_components_ajaxLoad__WEBPACK_IMPORTED_MODULE_10__["default"])();
  var initHeader = new _components_Header__WEBPACK_IMPORTED_MODULE_6__["default"]();
  (0,_components_inputNumber__WEBPACK_IMPORTED_MODULE_11__["default"])();
  (0,_components_initAnim__WEBPACK_IMPORTED_MODULE_12__["default"])();
  (0,_components_interactiveMap__WEBPACK_IMPORTED_MODULE_13__["default"])();
};
...
var Header = /*#__PURE__*/function () {
  function Header() {
    ...
    this.$menuTriggerTitle = this.$header.querySelector(this.SELECTORS.menuTriggerTitle);
    this.defaultTriggerTitle = this.$menuTriggerTitle.dataset.title;
    this.closeTriggerTitle = this.$menuTriggerTitle.dataset.closeTitle;
    this.$menuTrigger = this.$header.querySelector(this.SELECTORS.menuTrigger);
  ...
  _createClass(Header, [{
    ...
    get: function get() {
      return {
        ...
        menuTriggerTitle: '.header_menu__title'
      };
    }
  }, {
    key: "CLASSNAMES",
    ...
    value: function openMenu() {
      if (!this.openMenuState) {
        ...
        this.$menuTriggerTitle.innerHTML = this.closeTriggerTitle;
        this.openMenuState = true;
      } else {
        // console.log('close');
        this.$body.classList.remove(this.CLASSNAMES.bodyOpenMenuState);
        this.$menuTriggerTitle.innerHTML = this.defaultTriggerTitle;
        this.openMenuState = false;
      }
    }
  }, {
    ...
    value: function init() {
      ...
      if (typeof this.$header !== 'undefined' && this.$header != null) {
        (0,utils__WEBPACK_IMPORTED_MODULE_0__.onWindowScroll)(this.headerScroll);
...
function accordion(title, content) {
  //	hide all content
  var $accordionTitle = jquery__WEBPACK_IMPORTED_MODULE_0___default()(title);
  var $accordionContent = jquery__WEBPACK_IMPORTED_MODULE_0___default()(content);

  if ($accordionContent.length) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()($accordionContent).hide();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()($accordionTitle).on('click', function () {
      var $this = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
      $this.parent().toggleClass('active_mod').siblings().removeClass('active_mod');
      jquery__WEBPACK_IMPORTED_MODULE_0___default()($accordionContent).slideUp();
...
function ajaxLoad() {
  //	hide all content
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#load-more').on('click touch', function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
      ...
      data: {
        ...
        'page': cali_loadmore_params.current_page // current page

      },
      type: 'POST',
      beforeSend: function beforeSend(xhr) {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('#load-more').text('Loading...');
      },
      success: function success(posts) {
        if (posts) {
          jquery__WEBPACK_IMPORTED_MODULE_0___default()('#load-more').text('Load more');
          jquery__WEBPACK_IMPORTED_MODULE_0___default()('#load-more-container').append(posts); // insert new posts

          cali_loadmore_params.current_page++;
          if (cali_loadmore_params.current_page == cali_loadmore_params.max_page) jquery__WEBPACK_IMPORTED_MODULE_0___default()('#load-more').hide(); // if last page, HIDE the button
        } else {
          jquery__WEBPACK_IMPORTED_MODULE_0___default()('#load-more').hide(); // if no data, HIDE the button as well
        }
      }
    });
    return false;
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#sort-order').on('change', function () {
    var url = window.location.href;
    var parser = new URL(window.location);
    parser.searchParams.set('order', jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).val());
    window.location = parser.href;
  });
}

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ajaxLoad);

/***/ }),

/***/ "./src/js/components/initAnim.js":
/*!***************************************!*\
  !*** ./src/js/components/initAnim.js ***!
  \***************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var initAnim = function initAnim() {
  console.log('anim !');
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.registerPlugin(gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__.ScrollTrigger); // fade

  var $fadeEl = document.querySelectorAll('.fadeEl');

  if ($fadeEl) {
    gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.set($fadeEl, {
      y: 100,
      opacity: 0
    });
    gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__.ScrollTrigger.batch($fadeEl, {
  ...
  var $borderEl = document.querySelectorAll('.borderEl');

  if ($borderEl) {
    gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.set($borderEl, {
      scaleX: 0,
      transformOrigin: '0 0'
    });
    gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__.ScrollTrigger.batch($borderEl, {
      onEnter: function onEnter(batch) {
        return gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(batch, {
          scaleX: 1,
          stagger: 0.1,
  ...
  var $brochure = document.querySelectorAll('.brochureEl');
  $brochure.forEach(function (el, i) {
    var $decor = el.querySelectorAll('.brochureDecor');
    var $content = el.querySelectorAll('.brochureContent');
    var brochureTl = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.timeline({
      scrollTrigger: {
        trigger: $brochure,
        start: 'top 60%',
        once: true
    ...
    brochureTl.addLabel('start').fromTo($decor, {
      xPercent: gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.utils.wrap([200, -200]),
      yPercent: gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.utils.wrap([-200, 200]),
      opacity: 0
    }, {
      xPercent: 0,
      yPercent: 0,
      opacity: 1
    }, 'start').fromTo($content, {
      scaleX: 0,
      scaleY: 0
    }, {
      scaleX: 1,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (initAnim);

/***/ }),

/***/ "./src/js/components/initMap.js":
/*!**************************************!*\
  !*** ./src/js/components/initMap.js ***!
  \**************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var initMap = function initMap() {
  if (document.querySelector('#map')) {
    ...
    var mapOptions = {
      center: {
        lat: parseFloat(document.querySelector('.map_locations__item').dataset.x),
        lng: parseFloat(document.querySelector('.map_locations__item').dataset.y)
      },
      zoom: parseFloat(document.querySelector('#map').dataset.zoom),
      styles: _utils_constants__WEBPACK_IMPORTED_MODULE_1__.mapStyle
    };
    var coordX;
    var coordY;
    var infowindow;
    ...
    var i;
    var markerIcon;
    document.querySelectorAll('.map_locations__item').forEach(function (element) {
      var _element$dataset = element.dataset,
          x = _element$dataset.x,
          y = _element$dataset.y,
          title = _element$dataset.title,
          text = _element$dataset.text,
          link = _element$dataset.link;
      var obj = {
        title: title,
        text: text,
        x: x,
    ...
    loader.load().then(function (google) {
      ...
      document.querySelectorAll('.map_locations__item').forEach(function (element) {
        element.addEventListener('mouseenter', function () {
          var _element$dataset2 = element.dataset,
              x = _element$dataset2.x,
              y = _element$dataset2.y;
      ...
      var _loop = function _loop() {
        var marker = new google.maps.Marker({
          ...
          text: markersArr[i].text,
          link: markersArr[i].link
        });
        google.maps.event.addListener(marker, 'click', function () {
          infowindow.close();
          infowindow.setContent("<div class=\"map_popup\"><h3>".concat(this.title, "</h3><p>").concat(this.text, "</p><a href=\"").concat(this.link, "\">View Building</a></div>"));
...
/***/ "./src/js/components/inputNumber.js":
/*!******************************************!*\
  !*** ./src/js/components/inputNumber.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var initInputNumber = function initInputNumber() {
  var inputNumberArray = document.querySelectorAll('.inputNumber');

  if (inputNumberArray.length > 0) {
    inputNumberArray.forEach(function (item) {
      var $decrementBtn = item.querySelector('.decrementBtn');
      var $inputNumberElement = item.querySelector('.inputNumberElement');
      var $incrementBtn = item.querySelector('.incrementBtn');
      var dataMin = parseInt($decrementBtn.dataset.min);
      var dataMax = parseInt($incrementBtn.dataset.max); // console.log(inputNumberVal, dataMin, dataMax);

      $incrementBtn.addEventListener('click', function () {
        if ($inputNumberElement.value <= dataMax - 1) {
          $inputNumberElement.value++; // console.log($inputNumberElement.value);
        }
      });
      $decrementBtn.addEventListener('click', function () {
        if ($inputNumberElement.value >= dataMin + 1) {
          $inputNumberElement.value--; // console.log($inputNumberElement.value);
        }
      });
    });
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (initInputNumber);
...
var interactiveMap = function interactiveMap() {
  var loader = new _googlemaps_js_api_loader__WEBPACK_IMPORTED_MODULE_0__.Loader({
    apiKey: 'AIzaSyBrZNofhuwJ2QPvOjleVt53ytuDRrap5KM',
    version: 'weekly'
  });
  ...
  function loadMap() {
    loader.load().then(function (google) {
      var mapCenterLat = parseFloat($map.dataset.lat);

      if (Number.isNaN(mapCenterLat)) {
        throw new Error('Could not find map center latitude');
      }

      var mapCenterLng = parseFloat($map.dataset.lng);

      if (Number.isNaN(mapCenterLng)) {
        throw new Error('Could not find map center longitude');
      }

      var mapCenterZoom = parseInt($map.dataset.zoom);

      if (Number.isNaN(mapCenterZoom)) {
        throw new Error('Could not find map zoom');
      }
      ...
      var map = new google.maps.Map($map, mapOptions); // Markers are generated from locations datasets

      var $locations = Array.from(document.querySelectorAll('.interactiveMapLocation')); // Gets markers data

      var markersData = $locations.map(function ($location) {
        var lat = parseFloat($location.dataset.lat);

        if (isNaN(lat)) {
          throw new Error('Could not find location latitude');
        }

        var lng = parseFloat($location.dataset.lng);

        if (isNaN(lng)) {
          throw new Error('Could not find location longitude');
        }

        var markerTheme = Number($location.dataset.markerTheme);
        var markerLabel = String($location.dataset.markerLabel);
        return {
          lat: lat,
          lng: lng,
      ...
      markersData.forEach(function (markerData) {
        ...
        var marker = new google.maps.Marker({
          ...
          icon: iconStyles,
          label: _objectSpread({
            text: markerData.markerLabel
          }, labelStyles)
        }); // Add event listeners

        var $location = markerData.$location;
        var activeLocationClassName = 'interactive_map__locations_item--active_mod'; // `mouseover` and `mouseout` is for the devices that can hover the markers. `click` is for the devices that cannot hover the markers.

        if (window.matchMedia('(hover: hover)').matches) {
          google.maps.event.addListener(marker, 'mouseover', function () {
            $location.classList.add(activeLocationClassName);
          });
          google.maps.event.addListener(marker, 'mouseout', function () {
            $location.classList.remove(activeLocationClassName);
          });
        } else {
          google.maps.event.addListener(marker, 'click', function () {
            markersData.forEach(function (_ref) {
              var $loc = _ref.$location;
              console.log($loc);
              $loc.classList.remove(activeLocationClassName);
            });
            $location.classList.add(activeLocationClassName);
          });
        }
...
/***/ "./src/js/components/popupInit.js":
/*!****************************************!*\
  !*** ./src/js/components/popupInit.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var popupInit = function popupInit(popupBtn, popupClose, popup) {
  ...
  if ($popupBtn && $popup && $popupClose) {
    console.log('popup: ', $popup.classList[$popup.classList.length - 1]);
    $popupBtn.addEventListener('click', function () {
      $popup.classList.add('popup--active');
      $body.classList.add('body--popup_open_state');

      if ($popup.classList.contains('popup_wide')) {
        var $content = $popup.querySelector('.popupWideContent');

        if ($content) {
          gsap__WEBPACK_IMPORTED_MODULE_0__["default"].from($content, {
            opacity: 0,
            duration: 0.6
          });
        }

        var $bottomLeftAngle = $popup.querySelector('.popupWideAngleBottomLeft');

        if ($bottomLeftAngle) {
          gsap__WEBPACK_IMPORTED_MODULE_0__["default"].from($bottomLeftAngle, {
            xPercent: 200,
            yPercent: -200,
            opacity: 0,
            duration: 0.6
        ...
        var $topRightAngle = $popup.querySelector('.popupWideAngleTopRight');

        if ($topRightAngle) {
          gsap__WEBPACK_IMPORTED_MODULE_0__["default"].from($topRightAngle, {
            xPercent: -200,
            yPercent: 200,
            opacity: 0,
            duration: 0.6
        ...
        var $img = $popup.querySelector('.popupWideImgWrap');

        if ($img) {
          gsap__WEBPACK_IMPORTED_MODULE_0__["default"].from($img, {
            opacity: 0,
            duration: 0.6
          });
        }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (popupInit);

/***/ }),

/***/ "./src/js/components/sliderInit.js":
/*!*****************************************!*\
  !*** ./src/js/components/sliderInit.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var sliderInit = function sliderInit() {
  $('.main_slider__block').on('init reInit afterChange', function (event, slider, currentSlide, nextSlide) {
    var i = (currentSlide || 0) + 1;
    var count = slider.slideCount;
    $('.countCurrent').text(i < 10 ? "0".concat(i) : "".concat(i));
    $('.countTotal').text(count < 10 ? "0".concat(count) : "".concat(count));
    $('.sliderFullscreen').attr('data-fancybox-index', currentSlide);
  });
  $('.main_slider__block').slick({
    prevArrow: $('.main_slider__arrow.prev_mod'),
    nextArrow: $('.main_slider__arrow.next_mod'),
    infinite: false,
    slidesToShow: 1,
    slidesToScroll: 1,
    arrows: true,
  ...
  $('[data-fancybox="gallary_slider"]').on('click', function (e) {
    e.preventDefault();
  });
};
...
/***/ "./src/js/components/workspaceCard.js":
/*!********************************************!*\
  !*** ./src/js/components/workspaceCard.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function workspaceCard() {
  var $cardsArr = document.querySelectorAll('.workspaceCardAnim');

  if ($cardsArr.length) {
    var closeHandler;
    var openHandler;

    var _getWindowSize = (0,_utils_index__WEBPACK_IMPORTED_MODULE_1__.getWindowSize)(),
        windowWidth = _getWindowSize.windowWidth;

    var isMobile = windowWidth < _utils_constants__WEBPACK_IMPORTED_MODULE_2__.GLOBAL_VARS.mediaPoint2;

    if (!isMobile) {
      openHandler = function openHandler($inner, $dropdown, offset) {
        gsap__WEBPACK_IMPORTED_MODULE_3__["default"].to($inner, {
          y: -offset
        });
      ...
      closeHandler = function closeHandler($inner, $dropdown) {
        gsap__WEBPACK_IMPORTED_MODULE_3__["default"].to($inner, {
          y: 0
        });
        gsap__WEBPACK_IMPORTED_MODULE_3__["default"].to($dropdown, {
    ...
    $cardsArr.forEach(function (el) {
      var $inner = el.querySelector('.workspaceCardInner');
      var $dropdown = el.querySelector('.workspaceCardDropdown');

      if (!isMobile) {
        var $content = el.querySelector('.workspaceCardContent');
        var titleHeight;

        if (el.classList.contains('workspace_card--v4_mod')) {
          titleHeight = windowWidth < _utils_constants__WEBPACK_IMPORTED_MODULE_2__.GLOBAL_VARS.mediaPoint1 ? 75 : 70;
        } else {
          titleHeight = windowWidth < _utils_constants__WEBPACK_IMPORTED_MODULE_2__.GLOBAL_VARS.mediaPoint1 ? 75 : 125;
        }

        var offset = $content.clientHeight - titleHeight;

        if ($dropdown && offset > 0) {
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(el).on('focusin mouseenter', function () {
            return openHandler($inner, $dropdown, offset);
          });
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(el).on('focusout mouseleave', function () {
            return closeHandler($inner, $dropdown);
          });
        }
      } else {
        el.addEventListener('click', function () {
          jquery__WEBPACK_IMPORTED_MODULE_0___default()($dropdown).slideDown(300);
        });
      }
    });
  }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (workspaceCard);
...
var pageWidgetArray = [];
var pagesArray = ["about.pug","all_popup.pug","building.pug","contact.pug","events_and_news.pug","events_function_spaces.pug","event_child_2.pug","event_child_3.pug","food_and_drinks.pug","formery_1.pug","index.pug","meeting_and_venue.pug","memberships.pug","news_child.pug","product.pug","reques_tour.pug","shop.pug","workspaces.pug","workspace_details.pug"];
...
/***/ "./src/images/icons/sprite_icons/chevron_down.svg":
/*!********************************************************!*\
  !*** ./src/images/icons/sprite_icons/chevron_down.svg ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
      ...
      url: "/images/sprite/" + "sprite.svg#chevron_down-usage",
      toString: function () {
        return this.url;
      }
    });
...
/***/ "./src/images/icons/sprite_icons/instagram.svg":
/*!*****************************************************!*\
  !*** ./src/images/icons/sprite_icons/instagram.svg ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/images/icons/sprite_icons/left.svg":
/*!************************************************!*\
  !*** ./src/images/icons/sprite_icons/left.svg ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
      id: "left-usage",
      viewBox: "0 0 17.99 34.24",
      url: "/images/sprite/" + "sprite.svg#left-usage",
      toString: function () {
        return this.url;
      }
    });
...
/***/ "./src/images/icons/sprite_icons/linkedin.svg":
/*!****************************************************!*\
  !*** ./src/images/icons/sprite_icons/linkedin.svg ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/images/icons/sprite_icons/mail.svg":
/*!************************************************!*\
  !*** ./src/images/icons/sprite_icons/mail.svg ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/images/icons/sprite_icons/phone_icon.svg":
/*!******************************************************!*\
  !*** ./src/images/icons/sprite_icons/phone_icon.svg ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
      id: "phone_icon-usage",
      viewBox: "0 0 13.89 16.07",
      url: "/images/sprite/" + "sprite.svg#phone_icon-usage",
      toString: function () {
        return this.url;
      }
    });
...
/***/ "./src/images/icons/sprite_icons/right.svg":
/*!*************************************************!*\
  !*** ./src/images/icons/sprite_icons/right.svg ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
      id: "right-usage",
      viewBox: "0 0 17.99 34.24",
      url: "/images/sprite/" + "sprite.svg#right-usage",
      toString: function () {
        return this.url;
      }
    });
...
var map = {
	"./chevron_down.svg": "./src/images/icons/sprite_icons/chevron_down.svg",
	"./close.svg": "./src/images/icons/sprite_icons/close.svg",
	"./facebook.svg": "./src/images/icons/sprite_icons/facebook.svg",
	"./instagram.svg": "./src/images/icons/sprite_icons/instagram.svg",
	"./left.svg": "./src/images/icons/sprite_icons/left.svg",
	"./linkedin.svg": "./src/images/icons/sprite_icons/linkedin.svg",
	"./mail.svg": "./src/images/icons/sprite_icons/mail.svg",
	"./phone_icon.svg": "./src/images/icons/sprite_icons/phone_icon.svg",
	"./right.svg": "./src/images/icons/sprite_icons/right.svg",
